...
set "SCRIPT_DIR=%~dp0"
set "FIRMWARE_ROOT=%~1"
if "%FIRMWARE_ROOT%"=="" set "FIRMWARE_ROOT=%SCRIPT_DIR%..\ws63_fw\Midea_VenusA_WS63_35.03.01.01.18.26.05.04.00.01_20260519_021817"

rem Current WS63 bench profile. Override with env vars only after confirming polaris.local.json and serial probe.
